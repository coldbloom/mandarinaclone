				...
				<div className='image-slider-wrapper'>
					...
					>
						{hotel?.photoList.length ? (
							hotel?.photoList.map((photo: any, index: any) => (
								<SwiperSlide key={index}>
									<img
										src={`https://api.mandarina.lv/${
											photo?.urlPhoto || defaultPhoto
										}`}
										alt=''
				...
				<div className='' onClick={()=>navigate(`/hotel/${hotel?.hotelCode}`)}>
					...
					<div className='card_desc_price_include card_desc_price_include_sp'>
						...
						<div className='svg-wrapper'>
							...
							>
								<path
									d='M2.44766 4.10039C3.05517 4.10039 3.54766 3.6079 3.54766 3.00039C3.54766 2.39288 3.05517 1.90039 2.44766 1.90039C1.84014 1.90039 1.34766 2.39288 1.34766 3.00039C1.34766 3.6079 1.84014 4.10039 2.44766 4.10039Z'
									stroke='#546179'
									strokeWidth='2'
								></path>
								<path
									d='M11.2484 4.10039C11.856 4.10039 12.3484 3.6079 12.3484 3.00039C12.3484 2.39288 11.856 1.90039 11.2484 1.90039C10.6409 1.90039 10.1484 2.39288 10.1484 3.00039C10.1484 3.6079 10.6409 4.10039 11.2484 4.10039Z'
									stroke='#546179'
									strokeWidth='2'
								></path>
								<path
									d='M20.0492 4.10039C20.6567 4.10039 21.1492 3.6079 21.1492 3.00039C21.1492 2.39288 20.6567 1.90039 20.0492 1.90039C19.4417 1.90039 18.9492 2.39288 18.9492 3.00039C18.9492 3.6079 19.4417 4.10039 20.0492 4.10039Z'
									stroke='#546179'
									strokeWidth='2'
								></path>
							</svg>
