        ...
        <div className='col-12 col-lg-6 search-page-hotel-card'>
            <div className='slideComp'>
                ...
                <div className='name-star-wrapper name-star-wrapper_sp'>
                    <h1 className='card_desc_name_palace card_desc_name_palace_sp'>{hotel?.name}</h1>
                ...
                <div className=''>
                    ...
                    <p className='card_desc_type_eat card_description_body'>Длительность поездки от: {hotel?.hnights} ночи</p>
                ...
                <div className='price_wrap'>
                    ...
                    <div className='price_bold_wrapper_sp'>
                        <p className='price_bold price_bold_sp'>€ {hotel?.price}</p>
